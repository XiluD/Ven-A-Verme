      ...
      setListMunis(
        municipiosFiltered.map((municipio) => (
          <div
            className="muniCard"
            onClick={(e) =>
              listMuniClicked(`${municipio.municipio}, ${municipio.provincia}`)
            }
            style={{ backgroundImage: `url(${municipio.imagenMunicipio})` }}
          >
            <div className="gradient">
              <p className="cardInfo">
                {municipio.municipio}, {municipio.provincia}
              </p>
              <p className="cardInfo">población: {municipio.poblacion}</p>
            </div>
          </div>
        ))
      );
        ...
        {provincias && (
          ...
          >
            ...
            <div className="left_container">
              ...
              <div className="search_list_container">
                ...
                <div className="relative-positioner">
                  <ul className="listaProvincias">{listItems}</ul>
                </div>
              </div>
              ...
              <p id="info">
                Marcando esta casilla, nuestro buscador analizará la información
                de noticias relevantes sobre el municipio y aplicará un modelo
                de Inteligencia Artificial para determinar si se trata de un
                pueblo de la España vaciada o no.
              </p>
            ...
            <div className="right_container">
              ...
              {searchDone && <div className="cards_container">{listMunis}</div>}
            </div>
          </div>
        )}
      </div>
