...
function Login() {
    ...
    const handleLoginSubmit = (e) => {
        ...
        fetch(
            `http://127.0.0.1:8000/api/admin/${admin.email}/${admin.password}`,
            {
                method: "GET",
            ...
            .then((data) => {
                ...
                if (data.operation === "Success") {
                    alert(
                        `Successful login, remember your API_TOKEN: ${data.api_token}`
                    );
        ...
        if (adminForm.password !== adminForm.confirmPassword) {
            ...
            fetch(`http://127.0.0.1:8000/api/admin/`, {
                ...
                .then((data) => {
                    ...
                    if (data.operation === "Success") {
                        alert(
                            `Successfully created account, remember your API_TOKEN: ${data.api_token}`
                        );
                        setApiToken(data.api_token);
                    } else {
    ...
    return (
        <div className="login-card">
            <div className="left-container">
                <form
                    className="left-container-aligner"
            ...
            <div className="right-container">
                <form
                    className="right-container-aligner"
            ...
            <h1 className="api_token">API TOKEN: {apiToken}</h1>
        </div>
    );
}
