...
const MainWindow2 = () => {
    ...
    const handleCardClick2 = (cardLinkParam) => {
        setCardLink(cardLinkParam);
        setIsClicked(!isClicked);
    }
    const handleModalExit2 = () => {
        setIsClicked(!isClicked);
    }

    const MainContainer2 = ({ purposeContentType }) => {
        if (purposeContentType.queVisitar) {
            return (
                <div className={styles.mainInfoSection}>
                    {purposeContentType.queVisitar.length > 0 && <CardsContainer containerTypeContent={purposeContentType.queVisitar} title="Que visitar" handleCardClick2={handleCardClick2} />}
                    {purposeContentType.dondeComer.length > 0 && <CardsContainer containerTypeContent={purposeContentType.dondeComer} title="Donde comer" handleCardClick2={handleCardClick2} />}
                    {purposeContentType.alojamiento.length > 0 && <CardsContainer containerTypeContent={purposeContentType.alojamiento} title="Alojamiento" handleCardClick2={handleCardClick2} />}
                    {purposeContentType.otros.length > 0 && <CardsContainer containerTypeContent={purposeContentType.otros} title="Sigue el entretenimiento en" handleCardClick2={handleCardClick2} />}
                </div>
            );
        }
            ...
            return (
                <div className={styles.mainInfoSection}>
                    {purposeContentType.onSale.length > 0 && <CardsContainer containerTypeContent={purposeContentType.onSale} title="Casas en venta" handleCardClick2={handleCardClick2} />}
                    {purposeContentType.onRent.length > 0 && <CardsContainer containerTypeContent={purposeContentType.onRent} title="Casas en alquiler" handleCardClick2={handleCardClick} />}
                </div>
            );
        }
    };
    ...
    return (
        <div className={styles.mainWindowContainer}>
            {isClicked && cardLink && <ModalWindow cardLink = {cardLink} handleModalExit2 = {handleModalExit2}/>}
            ...
            {purposeContent && !purposeContent.closestPlace && <MainContainer2 purposeContentType={purposeContent} />}
            ...
            {purposeContent && purposeContent.closestPlace && <MainContainer2 purposeContentType={purposeContent.data} />}
