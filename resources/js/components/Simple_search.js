...
import Advanced_search_2 from "./Advanced_search_2";
...
function Simple_search() {
    ...
    return (
        <div className="simple-search">
            {isASClicked && (
                <Advanced_search handleModalExit={handleModalExit} />
            )}
            {isASClicked2 && (
                <Advanced_search_2 handleModalExit={handleModalExit2} />
            )}
